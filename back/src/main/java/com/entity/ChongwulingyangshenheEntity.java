...
public class ChongwulingyangshenheEntity<T> implements Serializable {
     ...
     * 申请结果
     */
    @TableField(value = "chongwulingyangshenhe_yesno_text")

    private String chongwulingyangshenheYesnoText;
	 ...
	 * 设置：申请结果
	 */
    public String getChongwulingyangshenheYesnoText() {
        return chongwulingyangshenheYesnoText;
    }
    /**
	 * 获取：申请结果
	 */

    public void setChongwulingyangshenheYesnoText(String chongwulingyangshenheYesnoText) {
        this.chongwulingyangshenheYesnoText = chongwulingyangshenheYesnoText;
    }
    /**
	 * 设置：创建时间
	 */
    ...
    public String toString() {
        return "Chongwulingyangshenhe{" +
            ...
            ", chongwulingyangshenheYesnoText=" + chongwulingyangshenheYesnoText +
