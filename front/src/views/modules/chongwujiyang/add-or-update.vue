        ...
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="寄养日期" prop="jiyangRiqiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd"
                                v-model="ruleForm.jiyangRiqiTime"
                                type="date"
                                placeholder="寄养日期"
                                :disabled="ro.jiyangRiqiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiyangRiqiTime" label="寄养日期" prop="jiyangRiqiTime">
                            <span v-html="ruleForm.jiyangRiqiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="寄养天数" prop="jiyangTianshu">
                       <el-input v-model="ruleForm.jiyangTianshu"
                                 placeholder="寄养天数" clearable  :readonly="ro.jiyangTianshu"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="寄养天数" prop="jiyangTianshu">
                           <el-input v-model="ruleForm.jiyangTianshu"
                                     placeholder="寄养天数" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="寄养地址" prop="jiyangdizhi">
                       <el-input v-model="ruleForm.jiyangdizhi"
                                 placeholder="寄养地址" clearable  :readonly="ro.jiyangdizhi"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="寄养地址" prop="jiyangdizhi">
                           <el-input v-model="ruleForm.jiyangdizhi"
                                     placeholder="寄养地址" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="寄养详情" prop="chongwujiyangContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.chongwujiyangContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.chongwujiyangContent" label="寄养详情" prop="chongwujiyangContent">
                            <span v-html="ruleForm.chongwujiyangContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.chongwujiyangYesnoTypes" label="审核状态" prop="chongwujiyangYesnoTypes">
                        <el-input v-model="ruleForm.chongwujiyangYesnoValue" placeholder="审核状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.chongwujiyangYesnoText" label="审核意见" prop="chongwujiyangYesnoText">
                        <span v-html="ruleForm.chongwujiyangYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    chongwuPhoto: false,
                    chongwuTypes: false,
                    jiyangRiqiTime: false,
                    jiyangTianshu: false,
                    jiyangdizhi: false,
                    lianxirenName: false,
                    lianxirenPhone: false,
                    chongwujiyangContent: false,
                    chongwujiyangYesnoTypes: false,
                    chongwujiyangYesnoText: false,
                    insertTime: false,
                },
                ruleForm: {
                    yonghuId: '',
                ...
                chongwuTypesOptions : [],
                chongwujiyangYesnoTypesOptions : [],
                yonghuOptions : [],
                rules: {
                   yonghuId: [
                   ...
                   jiyangRiqiTime: [
                              { required: true, message: '寄养日期不能为空', trigger: 'blur' },
                          ],
                   jiyangTianshu: [
                   ...
                   jiyangdizhi: [
                              { required: true, message: '寄养地址不能为空', trigger: 'blur' },
                          ],
                   lianxirenName: [
                   ...
                   chongwujiyangContent: [
                              { required: true, message: '寄养详情不能为空', trigger: 'blur' },
                          ],
                   chongwujiyangYesnoTypes: [
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=chongwujiyang_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.chongwujiyangYesnoTypesOptions = data.data.list;
                    }
                });
