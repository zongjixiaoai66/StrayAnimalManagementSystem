        ...
        <el-dialog title="审核" :visible.sync="chongwulingyangshenheYesnoTypesVisible">
            <el-form :model="form">
                ...
                <el-form-item label="审核" >
                    <el-select v-model="form.chongwulingyangshenheYesnoTypes" placeholder="请选择审核类型">
                        <el-option label="通过" value="2"></el-option>
                        <el-option label="拒绝" value="3"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="审核意见">
                    <el-input type="textarea" v-model="form.chongwulingyangshenheYesnoText" placeholder="审核意见"></el-input>
                </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer">
                <el-button @click="chongwulingyangshenheYesnoTypesVisible = false">取 消</el-button>
                <el-button type="primary" @click="chongwulingyangshenheYesnoTypesShenhe">提 交</el-button>
            </div>
        </el-dialog>
        <!-- 条件查询 -->
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '标题' : ''">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.chongwulingyangName" placeholder="标题" clearable></el-input>
                    </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        <el-button
                                v-if="isAuth('chongwulingyangshenhe','新增')"
                                type="success"
                                icon="el-icon-plus"
                        ...
                        &nbsp;
                        <el-button
                                v-if="isAuth('chongwulingyangshenhe','删除')"
                        ...
                        &nbsp;
                        <el-button
                                v-if="isAuth('chongwulingyangshenhe','报表')"
                                type="success"
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           v-if="isAuth('chongwulingyangshenhe','导入导出')"
                        ...
                        <el-upload
                                ...
                                :on-success="chongwulingyangshenheUploadSuccess"
                                :on-error="chongwulingyangshenheUploadError"
                                :show-file-list = false>
                            <el-button
                                    v-if="isAuth('chongwulingyangshenhe','导入导出')"
                                    type="success"
                                    icon="el-icon-upload2"
                            >批量导入宠物领养审核数据</el-button>
                        </el-upload>
                        &nbsp;
                        <!-- 导出excel -->
                        <download-excel v-if="isAuth('chongwulingyangshenhe','导入导出')" style="display: inline-block" class = "export-excel-wrapper" :data = "dataList" :fields = "json_fields" name = "chongwulingyangshenhe.xls">
                            <!-- 导出excel -->
                            <el-button
                                    type="success"
                                    icon="el-icon-download"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                          ...
                          v-if="isAuth('chongwulingyangshenhe','查看')"
                          :data="dataList"
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="chongwulingyangPhoto"
                               header-align="center"
                               width="200"
                               label="宠物图片">
                        <template slot-scope="scope">
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('chongwulingyangshenhe','删除')" type="danger" icon="el-icon-delete" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
                            <el-button v-if="isAuth('chongwulingyangshenhe','审核') && scope.row.chongwulingyangshenheYesnoTypes == 1 " type="primary" icon="el-icon-thumb" size="mini" @click="openYesnoTypes(scope.row.id,scope.row.chongwulingyangId)">审核</el-button>
...
<script>
    ...
    //当前表下拉框搜索条件
            form:{
                id : null,
                chongwulingyangId : null,
                yonghuId : null,
                chongwurenlingshenheText : null,
                chongwulingyangshenheYesnoTypes : null,
                chongwulingyangshenheYesnoText : null,
                createTime : null,
            },
            dataList: [],
            pageIndex: 1,
            ...
            chongwulingyangshenheYesnoTypesVisible : false,

            //导出excel
            json_fields: {
                //级联表字段
                     '标题': 'chongwulingyangName',
                     '宠物类型': 'chongwuTypes',
                     '宠物图片': 'chongwulingyangPhoto',
                     '是否被认领': 'jieshuTypes',
                     '用户姓名': 'yonghuName',
                     '头像': 'yonghuPhoto',
                     '手机号': 'yonghuPhone',
                     '电子邮箱': 'yonghuEmail',
                //本表字段
                     '认领凭据': "chongwurenlingshenheText",
                     '申请状态': "chongwulingyangshenheYesnoTypes",
                     '申请结果': "chongwulingyangshenheYesnoText",
            },
        ...
        methods: {
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        tableName :'chongwulingyangshenhe',//当前表表名,
                        sumColum : 'chongwulingyangshenhe_number', //求和字段
                        date : 'insert_time',//分组日期字段
                        // string : 'chongwulingyangshenhe_name',//分组字符串字段
                        // types : 'chongwulingyangshenhe_types',//分组下拉框字段
                    },
                    // joinTable : {//级联表（可以不存在）
                ...
                //         groupColumn: "chongwulingyangshenhe_types",
                //     }
                //     this.$http({
            ...
            getDataList() {
                ...
                if (this.searchForm.chongwulingyangName!= '' && this.searchForm.chongwulingyangName!= undefined) {
                    params['chongwulingyangName'] = '%' + this.searchForm.chongwulingyangName + '%'
                }
                ...
                params['chongwulingyangshenheDelete'] = 1// 逻辑删除字段 1 未删除 2 删除
            ...
            // 导入功能上传文件失败后调用导入方法
            chongwulingyangshenheUploadError(data){
            ...
            openYesnoTypes(id,chongwulingyangId) {
                ...
                _this.form.chongwulingyangId = chongwulingyangId;
				_this.form.chongwulingyangshenheYesnoText = null;
                _this.form.chongwulingyangshenheYesnoTypes = "请选择审核结果";
                _this.chongwulingyangshenheYesnoTypesVisible = true;
            },

            chongwulingyangshenheYesnoTypesShenhe() {
                let _this = this;
                if(_this.form.chongwulingyangshenheYesnoTypes == "请选择审核结果"){
                    alert("请选择审核结果");
                    return false;
                }
                if(_this.form.chongwulingyangshenheYesnoText == null || _this.form.chongwulingyangshenheYesnoText == ""){
                        alert("请输入审核原因");
                        return false;
                }
                this.$http({
                    ...
                    if (data && data.code === 0) {
						let par = {
							id:_this.form.chongwulingyangId,
							jieshuTypes:2
						}
                       this.$http({
                           ...
                           if (data && data.code === 0) {
                               this.$message({
                                   ...
                                   duration: 1500,
                                   onClose: () => {
                                       _this.chongwulingyangshenheYesnoTypesVisible = false;
                                       _this.search();
                                   }
                               });
                           } else {
