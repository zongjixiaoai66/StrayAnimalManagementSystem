        ...
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           v-if="isAuth('ziyuanzhe','导入导出')"
                           icon="el-icon-download"
                           href="http://localhost:8080/liulangdongwubeihua/upload/ziyuanzheMuBan.xls"
                        >批量导入自愿者数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('ziyuanzhe','导入导出')"
                                ...
                                :on-success="ziyuanzheUploadSuccess"
                                :on-error="ziyuanzheUploadError"
                        ...
                        &nbsp;
                        <!-- 导出excel -->
                        <download-excel v-if="isAuth('ziyuanzhe','导入导出')" style="display: inline-block" class = "export-excel-wrapper" :data = "dataList" :fields = "json_fields" name = "ziyuanzhe.xls">
                            <!-- 导出excel -->
                            <el-button
                                    type="success"
                                    icon="el-icon-download"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="ziyuanzhePhoto"
                                     header-align="center"
                                     width="200"
                                     label="头像">
                        <template slot-scope="scope">
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('ziyuanzhe','删除')" type="danger" icon="el-icon-delete" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>

                            <el-button v-if="isAuth('ziyuanzhe','修改')" type="success" icon="el-icon-tickets" size="mini" @click="resetPassword(scope.row.id)">重置密码</el-button>
                        </template>
                    </el-table-column>
                </el-table>
                <el-pagination
        ...
        methods: {
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        tableName :'ziyuanzhe',//当前表表名,
                        sumColum : 'ziyuanzhe_number', //求和字段
                        date : 'insert_time',//分组日期字段
                        // string : 'ziyuanzhe_name',//分组字符串字段
                        // types : 'ziyuanzhe_types',//分组下拉框字段
                    },
                    // joinTable : {//级联表（可以不存在）
            ...
            getDataList() {
                ...
                params['ziyuanzheDelete'] = 1// 逻辑删除字段 1 未删除 2 删除
