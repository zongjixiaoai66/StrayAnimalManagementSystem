        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        <el-button
                                v-if="isAuth('dictionaryChongwulingyangshenheYesno','新增')"
                                type="success"
                                icon="el-icon-plus"
                                @click="addOrUpdateHandler()"
                        >新增</el-button>
                        <el-button
                                v-if="isAuth('dictionaryChongwulingyangshenheYesno','删除')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                          ...
                          v-if="isAuth('dictionaryChongwulingyangshenheYesno','查看')"
                          :data="dataList"
    ...
    export default {
        ...
        methods: {
            ...
            getDataList() {
                ...
                //本表的
                params['dicCode'] = "chongwulingyangshenhe_yesno_types"//编码名字
