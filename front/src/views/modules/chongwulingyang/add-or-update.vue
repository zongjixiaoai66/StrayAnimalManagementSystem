               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="标题" prop="chongwulingyangName">
                       <el-input v-model="ruleForm.chongwulingyangName"
                                 placeholder="标题" clearable  :readonly="ro.chongwulingyangName"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="宠物类型" prop="chongwuTypes">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.chongwulingyangPhoto" label="宠物图片" prop="chongwulingyangPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.chongwulingyangPhoto?ruleForm.chongwulingyangPhoto:''"
                            @change="chongwulingyangPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="是否被认领" prop="jieshuTypes">
                        <el-select v-model="ruleForm.jieshuTypes" :disabled="ro.jieshuTypes" placeholder="请选择是否被认领">
                            <el-option
                                v-for="(item,index) in jieshuTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else>
                        <el-form-item class="input" label="是否被认领" prop="jieshuValue">
                        <el-input v-model="ruleForm.jieshuValue"
                            placeholder="是否被认领" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="宠物详情" prop="chongwulingyangContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.chongwulingyangContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.chongwulingyangContent" label="宠物详情" prop="chongwulingyangContent">
                            <span v-html="ruleForm.chongwulingyangContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                userId:"",//当前登录人的id
                ro:{
                    chongwulingyangName: false,
                    chongwuTypes: false,
                    chongwulingyangPhoto: false,
                    jieshuTypes: false,
                    chongwulingyangContent: false,
                },
                ruleForm: {
                    chongwulingyangName: '',
                    chongwuTypes: '',
                ...
                rules: {
                   ...
                   jieshuTypes: [
                              { required: true, message: '是否被认领不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    ...
                    if (data && data.code === 0) {
                        this.jieshuTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            //图片
            chongwulingyangPhotoUploadChange(fileUrls){
                this.ruleForm.chongwulingyangPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
