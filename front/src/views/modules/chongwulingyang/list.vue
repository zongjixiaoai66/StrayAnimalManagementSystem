        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        <el-button
                                v-if="isAuth('chongwulingyang','新增')"
                                type="success"
                                icon="el-icon-plus"
                        ...
                        &nbsp;
                        <el-button
                                v-if="isAuth('chongwulingyang','删除')"
                        ...
                        &nbsp;
                        <el-button
                                v-if="isAuth('chongwulingyang','报表')"
                                type="success"
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           v-if="isAuth('chongwulingyang','导入导出')"
                           icon="el-icon-download"
                           href="http://localhost:8080/liulangdongwubeihua/upload/chongwulingyangMuBan.xls"
                        >批量导入宠物领养数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('chongwulingyang','导入导出')"
                                ...
                                :on-success="chongwulingyangUploadSuccess"
                                :on-error="chongwulingyangUploadError"
                                :show-file-list = false>
                            <el-button
                                    v-if="isAuth('chongwulingyang','导入导出')"
                                    type="success"
                                    icon="el-icon-upload2"
                            >批量导入宠物领养数据</el-button>
                        </el-upload>
                        &nbsp;
                        <!-- 导出excel -->
                        <download-excel v-if="isAuth('chongwulingyang','导入导出')" style="display: inline-block" class = "export-excel-wrapper" :data = "dataList" :fields = "json_fields" name = "chongwulingyang.xls">
                            <!-- 导出excel -->
                            <el-button
                                    type="success"
                                    icon="el-icon-download"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                          ...
                          v-if="isAuth('chongwulingyang','查看')"
                          :data="dataList"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('chongwulingyang','删除')" type="danger" icon="el-icon-delete" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
...
<script>
    ...
    //当前表下拉框搜索条件
            ...
            form:{
                id : null,
                chongwulingyangName : null,
                chongwuTypes : null,
                chongwulingyangPhoto : null,
                jieshuTypes : null,
                chongwulingyangContent : null,
                createTime : null,
            },
            dataList: [],
            pageIndex: 1,
        ...
        methods: {
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        tableName :'chongwulingyang',//当前表表名,
                        sumColum : 'chongwulingyang_number', //求和字段
                        date : 'insert_time',//分组日期字段
                        // string : 'chongwulingyang_name',//分组字符串字段
                        // types : 'chongwulingyang_types',//分组下拉框字段
                    },
                    // joinTable : {//级联表（可以不存在）
                ...
                //         groupColumn: "chongwulingyang_types",
                //     }
                //     this.$http({
            ...
            getDataList() {
                ...
                params['chongwulingyangDelete'] = 1// 逻辑删除字段 1 未删除 2 删除
            ...
            // 导入功能上传文件成功后调用导入方法
            chongwulingyangUploadSuccess(data){
                let _this = this;
                _this.$http({
                    url: "chongwulingyang/batchInsert?fileName=" + data.file,
                    method: "get"
                }).then(({data}) => {
                    if(data && data.code === 0){
                        _this.$message({
            ...
            // 导入功能上传文件失败后调用导入方法
            chongwulingyangUploadError(data){
