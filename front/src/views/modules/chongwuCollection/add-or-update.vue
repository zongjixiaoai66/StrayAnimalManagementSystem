        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='chongwu'">
                    <el-form-item class="select" v-if="type!='info'"  label="宠物信息" prop="chongwuId">
                        <el-select v-model="ruleForm.chongwuId" :disabled="ro.chongwuId" filterable placeholder="请选择宠物信息" @change="chongwuChange">
                            <el-option
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="类型" prop="chongwuCollectionTypes">
                        <el-select v-model="ruleForm.chongwuCollectionTypes" :disabled="ro.chongwuCollectionTypes" placeholder="请选择类型">
                            <el-option
                                v-for="(item,index) in chongwuCollectionTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="类型" prop="chongwuCollectionValue">
                        <el-input v-model="ruleForm.chongwuCollectionValue"
        ...
        data() {
            return {
                ...
                ro:{
                    chongwuId: false,
                    yonghuId: false,
                    chongwuCollectionTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    chongwuId: '',
                    yonghuId: '',
                    chongwuCollectionTypes: '',
                    insertTime: '',
                },
                chongwuCollectionTypesOptions : [],
                chongwuOptions : [],
                yonghuOptions : [],
                rules: {
                   chongwuId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    ...
                    if (data && data.code === 0) {
                        this.chongwuCollectionTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.chongwuChange(data.data.chongwuId)
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`chongwuCollection/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.chongwuCollectionCrossAddOrUpdateFlag = false;
                                        this.parent.search();
