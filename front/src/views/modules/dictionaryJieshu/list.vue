        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item label="是否被认领">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.indexNameSearch" placeholder="是否被认领" clearable></el-input>
                    </el-form-item>
                    <el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        <el-button
                                v-if="isAuth('dictionaryJieshu','新增')"
                                type="success"
                                icon="el-icon-plus"
                                @click="addOrUpdateHandler()"
                        >新增</el-button>
                        <el-button
                                v-if="isAuth('dictionaryJieshu','删除')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                          ...
                          v-if="isAuth('dictionaryJieshu','查看')"
                          :data="dataList"
    ...
    export default {
        ...
        methods: {
            ...
            getDataList() {
                ...
                //本表的
                params['dicCode'] = "jieshu_types"//编码名字
                params['dicName'] = "是否被认领",//汉字名字
                this.$http({
                    url: "dictionary/page",
                    method: "get",
                    params: params
