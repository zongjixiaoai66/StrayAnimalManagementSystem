                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/liulangdongwubeihua/upload/chongwuLiuyanMuBan.xls"
                        >批量导入宠物留言数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('chongwuLiuyan','导入导出')"
                                ...
                                :on-success="chongwuLiuyanUploadSuccess"
                                :on-error="chongwuLiuyanUploadError"
                                :show-file-list = false>
                            <el-button
                                    v-if="isAuth('chongwuLiuyan','导入导出')"
                                    type="success"
                                    icon="el-icon-upload2"
                            >批量导入宠物留言数据</el-button>
                        </el-upload>
                        &nbsp;
                        <!-- 导出excel -->
                        <download-excel v-if="isAuth('chongwuLiuyan','导入导出')" style="display: inline-block" class = "export-excel-wrapper" :data = "dataList" :fields = "json_fields" name = "chongwuLiuyan.xls">
                            <!-- 导出excel -->
                            <el-button
                                    type="success"
                                    icon="el-icon-download"
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('chongwuLiuyan','删除')" type="danger" icon="el-icon-delete" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
        ...
        methods: {
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        tableName :'chongwu_liuyan',//当前表表名,
                        sumColum : 'chongwu_liuyan_number', //求和字段
                        date : 'insert_time',//分组日期字段
                        // string : 'chongwu_liuyan_name',//分组字符串字段
                        // types : 'chongwu_liuyan_types',//分组下拉框字段
                    },
                    // joinTable : {//级联表（可以不存在）
                ...
                //         groupColumn: "chongwu_liuyan_types",
                //     }
                //     this.$http({
            ...
            getDataList() {
                ...
                params['chongwuLiuyanDelete'] = 1// 逻辑删除字段 1 未删除 2 删除
