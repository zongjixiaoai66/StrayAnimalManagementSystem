    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="chongwuLiuyanText">
                        <el-input type="textarea"  :readonly="ro.chongwuLiuyanText" v-model="ruleForm.chongwuLiuyanText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.chongwuLiuyanText" label="留言内容" prop="chongwuLiuyanText">
                            <span v-html="ruleForm.chongwuLiuyanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.chongwuId = true;//宠物
                this.ro.yonghuId = true;//用户
                this.ro.chongwuLiuyanText = true;//留言内容
            }
                            ...
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.chongwuLiuyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
